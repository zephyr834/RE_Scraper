 ...
 */
  FSR.properties = {
    ...
    invite: {
      ...
      dialogs: [
        [{
          reverseButtons: false,
          headline: "We'd welcome your feedback!",
          blurb: "Thank you for visiting Realtor.com. You have been selected to participate in a brief customer satisfaction survey to let us know how we can improve your experience.",
    ...
    cpps: {
      ...
      Visitor_ID: {
        source: 'variable',
        name: 'Realtor.Persistent.getVisitorId()'
      },
      VisitorID: {
        source: 'cookie',
        name: 'AMCV_8853394255142B6A0A4C98A4%40AdobeOrg'
      },
      threshold_value: {
        source: 'cookie',
